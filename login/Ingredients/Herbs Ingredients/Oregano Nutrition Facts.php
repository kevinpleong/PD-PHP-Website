...
<head>
  <title>Oregano Nutrition Facts</title>
...
<body class="container">
  ...
  <div class="row ">
    <div class="col-md-12"></div>
      ...
      <div class="row">
        <div class="col-md-4">
          <img class="img-responsive" src="./Assets/Oregano.jpg" alt="">
        </div>
      </div>
      <ul>
        <li>High in:</li>
        <ul>
          ...
          <li>This nontoxic herb helps with digestive problems, diarrhea, and gas</li>
        </ul>
      </ul>
