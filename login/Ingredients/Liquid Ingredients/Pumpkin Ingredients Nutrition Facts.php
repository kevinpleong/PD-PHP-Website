...
<head>
  <title>Pumpkin Nutrition Facts</title>
...
<body class="container">
  ...
  <div class="row ">
    <div class="col-md-12 ">
      ...
      <div class="row">
        <div class="col-md-4">
          <img class="img-responsive" src="./Assets/Pumpkins.jpeg" alt="Image of pumpkins stacked on top of each other">
        </div>
      </div>
      <br>
      <ul>
        ...
        <li>High source of:</li>
        <ul>
          <li>Vitamin A</li>
          <li>Potassium</li>
          <li>Helps regulate blood pressure</li>
          <li>Improves muscle health</li>
          <li>Assists in metabolism</li>
        </ul>
        <li>It contains small amounts of:</li>
        <ul>
          <li>Vitamin C</li>
          <li>Iron</li>
          <li>Phosphorus</li>
