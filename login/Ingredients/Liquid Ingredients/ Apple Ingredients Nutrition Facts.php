...
<head>
  <title>Apple Nutrition Facts</title>
...
<body class="container">
  ...
  <div class="row ">
    <div class="col-md-12 ">
      ...
      <h1><b>Liquid Ingredient Nutrition Facts</b></h1>
      <h2><b>Apples</b></h2>
      </h2>
      <div class="row">
        <div class="col-md-4">
          <img class="img-responsive" src="./Assets/Apples.jpg" alt="Image shows lots of red apples">
        </div>
      </div>
      <ul>
        <li>Source of vitamin A</li>
        <li>Source of vitamin C</li>
        <li>Breath Freshener</li>
        <li>Low in calories</li>
        <li>High in dietary Fiber</li>
        <li>Breathe freshener</li>
        <li>Promotes dental health and care</li>
        <br>
      </ul>
