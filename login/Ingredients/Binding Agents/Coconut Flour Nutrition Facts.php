...
<head>
  <title>Coconut Flour nutrition Facts</title>
...
<body class="container">
  ...
  <div class="row ">
    ...
    <div class="col-md-12 ">
      <h2>Coconut Flour Nutrition Facts</h2>
      <hr> 
      <div class="row">
        <div class="col-md-4">
          <img class="img-responsive" src="./Assets/#.jpg" alt="#">
        </div>
      </div>
      <div class="row">
        <div class="col-md-4">
          <img class="img-responsive" src="./Assets/Coconut flour.jpeg" alt="A whole cocount, half a coconut showing the flesh of a coconut, and  plate of coconut flour">
        </div>
      </div>
      <ul>
