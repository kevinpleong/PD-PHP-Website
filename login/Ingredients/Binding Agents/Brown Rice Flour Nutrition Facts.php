...
<head>
  <title>Brown Rice Flour Nutrition Facts</title>
...
<body class="container">
  ...
  <div class="row ">
    <div class="col-md-12 ">
      <h2>Brown Rice Flour Nutrition Facts</h2>
      <hr>
      <h2><b>Brown Rice Flour</b></h2>
      <div class="row">
        <div class="col-md-4">
          <img class="img-responsive" src="./Assets/Brown rice flour.jpeg" alt="Brown rice grains and brown rice flour">
        </div>
      </div>
      <ul>
